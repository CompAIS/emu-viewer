...
a = Analysis(
    ...
    hiddenimports=[
        'PIL._tkinter_finder',
        'src.widgets.renderer.renderer_widget',
        'src.widgets.image_table.image_table_widget',
        'src.widgets.contour.contour_widget',
        'src.widgets.catalogue.catalogue_widget',
        'src.widgets.statistics.statistics_widget',
